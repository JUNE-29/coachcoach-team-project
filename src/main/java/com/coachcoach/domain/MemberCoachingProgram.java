...
public class MemberCoachingProgram implements Serializable {
	...
	public CoachingProgram getCp() {
		return cp;
	}
	public void setCp(CoachingProgram cp) {
		this.cp = cp;
	}
	public int getFee() {
		return fee;
	...
	public String toString() {
		return "MemberCoachingProgram [no=" + no + ", memberNo=" + memberNo + ", programNo=" + programNo + ", remark="
				+ remark + ", status=" + status + ", requestDate=" + requestDate + ", payDate=" + payDate + ", startDate="
				+ startDate + ", endDate=" + endDate + ", starRate=" + starRate + ", review=" + review + ", reviewDate="
				+ reviewDate + ", etc=" + etc + ", member=" + member + ", programName=" + programName + ", coach=" + coach
				+ ", cp=" + cp + ", fee=" + fee + "]";
	}
