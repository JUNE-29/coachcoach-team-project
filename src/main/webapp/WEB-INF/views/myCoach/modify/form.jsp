...
<label for="updatePassword" style="width:145px; font-weight:bold; ">아이디</label>${member.id}
  </div>
  <div class="form-group"  >
<label for="updatePassword" style="width:145px; font-weight:bold;  ">이름</label>${member.name}
  </div>
<div class="form-group"  ><label for="updatePassword" style="width:140px;   font-weight:bold;  ">성별</label>
...
<div class="form-group"  >
<label for="updatePassword" style="width:145px;  font-weight:bold; ">생년월일</label>${member.birth}
  </div>
<div class="form-group"  >
<label for="updatePassword" style="width:120px;  font-weight:bold; ">전화번호</label>
    <input  id='tel'  name='tel'  type="text"   class="form-control mx-sm-3"  value="${member.tel}" style="width:300px; display:inline">
    <small id="passwordHelpInline" class="text-muted">
    </small>
  </div>
<div class="form-group"  >
<label for="updatePassword" style="width:120px;  font-weight:bold; ">이메일</label>
    <input  id='email'  name='email'  type="email"  class="form-control mx-sm-3"  value="${member.email}" style="width:300px; display:inline">
    <small id="passwordHelpInline" class="text-muted">
    </small>
  </div>
<div class="form-group"  >
    <label for="updatePassword" style="width:120px;  font-weight:bold; ">새 비밀번호</label>
  ...
  <div class="form-group"  >
    <label for="updatePassword"  style="font-weight:bold; ">새 비밀번호 확인</label>
