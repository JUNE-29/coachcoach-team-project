...
.cofirmBtn_area button[type=button] {display:inline-block; width:30%; height:50px; background:#01b1d7; color:#FFFFFF; font-weight:bold; font-size:15px; border:none;}
</style>
...
<div class="text">
<h1 class="title">회원 가입을 축하드립니다.</h1> <br>
