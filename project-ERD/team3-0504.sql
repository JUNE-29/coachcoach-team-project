...
-- 회원운동태그
DROP TABLE IF EXISTS member_workout_tag RESTRICT;
...
-- 회원운동태그
CREATE TABLE member_workout_tag (
...
-- 회원운동태그
ALTER TABLE member_workout_tag
...
ALTER TABLE workout_list_tag
  ADD CONSTRAINT FK_member_workout_tag_TO_workout_list_tag -- 회원운동태그 -> 운동리스트태그
    ...
    REFERENCES member_workout_tag ( -- 회원운동태그
      workout_no -- 운동번호
    );
