...
CREATE TABLE workout_unit (
  workout_unit_no INTEGER NOT NULL COMMENT '운동번호', -- 운동번호
  workout_no      INTEGER NULL     COMMENT '운동번호2', -- 운동번호2
...
ALTER TABLE workout_unit
  ADD CONSTRAINT PK_workout_unit -- 운동시간 기본키
    PRIMARY KEY (
...
-- 운동내역
ALTER TABLE member_workouts
  ADD CONSTRAINT FK_workout_unit_TO_member_workouts -- 운동시간 -> 운동내역
    FOREIGN KEY (
      workout_unit_no -- 운동번호
    )
    REFERENCES workout_unit ( -- 운동시간
      workout_unit_no -- 운동번호
    );
...
-- 운동시간
ALTER TABLE workout_unit
  ADD CONSTRAINT FK_workout_TO_workout_unit -- 운동 -> 운동시간
    FOREIGN KEY (
      workout_no -- 운동번호2
    )
...
-- 운동리스트태그
ALTER TABLE workout_list_tag
  ADD CONSTRAINT FK_workout_unit_TO_workout_list_tag -- 운동시간 -> 운동리스트태그
    FOREIGN KEY (
      workout_unit_no -- 운동번호
    )
    REFERENCES workout_unit ( -- 운동시간
